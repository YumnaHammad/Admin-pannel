...
const UpgradeButton = ({className,children}) => {
  ...
  return (
    ...
    <div>
       <button
                  className={`relative overflow-hidden text-white  ${className} rounded-full flex items-center text-sm font-medium transition-transform duration-200 ease-out group text-center justify-center`}
