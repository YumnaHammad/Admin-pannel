...
const steps = [
  ...
  },
  {
    ...
    titleClass: "text-left font-bold text-[20px]",
    content:
      "Blynk platform consists of four main components that work seamlessly together",
    title2: "Blynk library:",

    title3: "Blynk.Console:",
    content3:
      "web application where you can configure, connect, oversee your devices, analyze sensor data, update firmware OTA, and manage how other users and organizations access their devices.",
    titleClass3: "text-left ",
    contentClass3: "text-left py-3 mt-3",

    title4: "Blynk.Apps:",
    content4:
      "mobile apps for iOS and Android where you can build UI for you devices with no coding, and share it with other users.",
    ...
    image: bylnktour2,
    content2:
      "enables device communication with Blynk.Cloud. Blynk.Edgent includes this library, dynamic WiFi provisioning, and OTA updates and is recommended for supported hardware at all times.",
  },
  {
    Mtitle: "Modes",
    ...
    content2:
      "(which you are currently using), allows you to configure how devices should work.",
    titleClass2: "text-left ",
    contentClass2: "text-left py-3 mt-3",

    title3: "User Mode",
    content3:
      "allows to monitor and control the devices, but doesn't allow to modify any configurations.",
    titleClass3: "text-left ",
    contentClass3: "text-left py-3 mt-3",
    contentClass4: "text-left py-3 mt-3",
    content4:
      "You can switch the Developer Mode on/off in User Profile section of the main menu",
  },
  {
    Mtitle: "Devices",
    ...
    contentClass4: "text-left py-3 mt-3",
    content4:
      "Your device can connect to the cloud using WiFi, Ethernet, Сellular, LoRaWAN, or Satellite.",
    contentClass3: "text-left py-3 mt-3",

    content3:
      "A device is usually a microcontroller (MCU) like TI CC3220, ESP32, Seeed Wio Terminal, Arduino, etc. You can attach sensors and actuators to an MCU and monitor or control them with Blynk.",
  ...
  },
  {
    ...
    content:
      "Device configurations are stored in something we call Device Template. Multiple individual devices can be created from the same template (product), making it easy to manage them all from one place.",
    image: blynktour4,
    ...
    content6:
      "Updating a template will update all devices that were made from it.",
  ...
  },
  {
    ...
    contentClass6: " py-5",
    content7:
      "Now if you have your device handy, let’s start with getting it online!",
    contentClass7: "py-5",
  },
];
      ...
      <div className="w-[1200px]  bg-white rounded-lg shadow-lg p-7 h-[500px] overflow-hidden flex flex-col ">
              ...
              {index > 0 && (
                <div
                  className={`absolute -left-[97px] w-[90px] h-[2px] mt-1 ${
                    index <= step ? "bg-[#00667C]" : "bg-gray-300"
                  }`}
                ></div>
              )}
              <div
        ...
        <div className="flex  space-x-6 flex-grow overflow-auto p-2 custom-scrollbar mt-1 text-left ">
          <div className="w-1/2 h-full text-left  ">
            ...
            <p className={` ${steps[step].contentClass2}`}>
              <span
            ...
            <p className={` ${steps[step].contentClass6}`}>
              {" "}
              {steps[step].content6}
            </p>
            <p className={` ${steps[step].contentClass7}`}>
              {" "}
              {steps[step].content7}
            </p>
          </div>
        ...
        <div>
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            {step === 0 ? (
              <div className="flex space-x-4">
                ...
                <button
                  onClick={() => setStep(step + 1)}
                  className="px-4 py-2 bg-[#00667C] hover:bg-[#00667C] transition-all duration-300 text-white rounded-md flex items-center shadow-md"
                >
          ...
          {showModal && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
              <div className="bg-white rounded-lg shadow-lg p-6 w-80 items-center">
                ...
                <div className="mt-4 p-4 bg-green-100 rounded-md">
                  ...
                  <p className="text-sm text-gray-700">
                    We’ve prepared a quick and easy way to connect your first
                    device.
                  </p>
                </div>
                ...
                <button
                  onClick={onClose}
                  className="mt-4 px-4 py-2 bg-[#00667C] hover:bg-[#00667C] text-white rounded-md items-center"
                >
