...
const Templates = ({ isExpanded, toggleSection  }) => {
    ...
    const filterContent = () => {
      ...
      return [
        {
          section: "Templates",
          content: ["View templates", "Add new templates", "Edit templates", "Delete templates", "Enable offline automation", "Manage voice assistance", "Publish Blueprint", "Manage Blueprints"],
        },
      ].filter(
        ({ section, content }) =>
