      ...
      <div className="flex-1 pt-6 pl-6 w-full">
        ...
        <div className="flex justify-between">
          <div className="mt-4 flex px-1 py-1 relative items-center dark:bg-gray-700">
            ...
            >
              <PiSlidersLight size={20} className="cursor-pointer" />
              {format(dateRange[0].startDate, "yyyy-MM-dd")} →{" "}
              {format(dateRange[0].endDate, "yyyy-MM-dd")}
              <PiCalendarBlankLight size={20} className="cursor-pointer" />
            </button>
            {/* Date Picker Modal */}
            {showDatePicker && (
          ...
          <div className="flex gap-2">
            <button className="px-6 bg-gray-200 rounded-md flex items-center text-xs font-medium dark:text-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700">
              <CgOrganisation className="text-[20px] text-[#56575D] dark:text-gray-100 me-2" size={17} />
              All organi...
            </button>
        ...
        {/* No Widgets Section */}
        <div className="mt-[80px] text-center ms-[-60px]">
          <p className="text-xl font-medium">No widgets</p>
          <button className="mt-3 px-6 py-2 bg-[#00667C] dark:bg-gray-600 text-white rounded-md flex items-center mx-auto gap-2">
            🛠 Edit Dashboard
          </button>
        </div>
      </div>
